...
class SvhnResnet:
    ...
    def _build_model(self, input_shape=[32, 32, 3], blocks=[3,4,6,3], num_classes=10):
        ...
        y = Flatten()(x)
        y = Lambda(lambda x: K.dropout(x, level=self.dr1))(y)
...
### QUERY functions for active learning
    ...
    def _load_data(self):
        ...
        mat = spio.loadmat('train_32x32.mat', squeeze_me=True)
        self.x_train = mat["X"]
        self.y_train = mat["y"]
        self.x_train = np.moveaxis(self.x_train, -1, 0)
        del mat

        mat = spio.loadmat('test_32x32.mat', squeeze_me=True)
        self.x_test = mat["X"]
        self.y_test = mat["y"]
        del mat
        ...
        self.y_train = keras.utils.to_categorical(self.y_train - 1, 10)
        self.y_test = keras.utils.to_categorical(self.y_test - 1, 10)
    ...
    def search_blocks(self, structures):
        ...
        for struct in structures:
            ...
            print("Accuracy for {} is {}".format(struct,self.max_accuracy))
